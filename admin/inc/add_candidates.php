...
?>
       <div class="alert alert-danger mx-3 my-3" role="alert">
            Candidate is deleted successfully!
        </div>
<?php
...
<div class="row mx-3 my-3">
    <div class="col-4">
        <h3 class="mx-3">Add New Candidates</h3>
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <select class="form-control  my-3" name="election_id" required> 
            ...
            <input type="submit" value="Add Candidate" name="addCandidateBtn" class="btn btn-success  my-3" />
        </form>
    </div>   
    ...
    <div class="col-8">
        ...
        <table class="table">
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <button class="btn btn-sm btn-danger" onclick="DeleteData(<?php echo $candidatedel_id; ?>)"> Delete </button>
                                </td>
                            </tr>   
                <?php
                        }
            ...
            ?>
                        <tr> 
                            <td  class=""  colspan="7"> No any candidate is added yet. </td>
                        </tr>
            <?php
                    }
                ?>
